...
#3) the filename of the mitocontig generated by the script map10x1.sh after trimming.
...
#align
bowtie2-build ${W_URL}/arrow/freebayes_round1/${CONTIG} ${W_URL}/bowtie2_round2/${ABBR}
